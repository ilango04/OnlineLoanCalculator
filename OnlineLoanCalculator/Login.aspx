        ...
        <div>
            <asp:Table runat="server">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell><asp:TextBox ID="txtPassword" TextMode="Password" size="16" runat="server"></asp:TextBox></asp:TableCell>
                    <asp:TableCell><asp:RequiredFieldValidator ID="password" runat="server" ControlToValidate="txtPassword" ErrorMessage="Please enter a password"   
